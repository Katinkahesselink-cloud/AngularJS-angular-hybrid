...
class UsersController implements ng.IController {
  ...
  constructor(
    ...
    this.$scope.showModernAdd = false;
    ...
    this.$scope.toggleModernAdd = this.toggleModernAdd;
  }
  ...
  private toggleModernAdd = (): void => {
    this.$scope.showModernAdd = !this.$scope.showModernAdd;
  };
}
